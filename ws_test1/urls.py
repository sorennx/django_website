...
urlpatterns = [
    ...
    re_path(r'^projects/uniprojects/responsive/rwd$',views.responsive,name='responsive'),
    re_path(r'^projects/uniprojects/tablesandforms/formscalcs$',views.formscalcs,name='tablesandforms'),
